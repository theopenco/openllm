		...
		<div className="min-h-screen bg-black text-white p-6">
			<div className="flex items-center justify-between mb-8">
				...
				<div className="flex items-center gap-4">
					<Skeleton className="h-9 w-32 bg-neutral-800 rounded-lg" />
					<Skeleton className="h-9 w-32 bg-neutral-800 rounded-lg" />
				</div>
			</div>
			...
			<div className="flex gap-2 mb-6">
				...
				<Skeleton className="h-10 w-28 bg-neutral-800 rounded-lg" />
			</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
				{Array.from({ length: 4 }).map((_, i) => (
					<Card key={i} className="bg-neutral-900 border-neutral-800">
						...
						<CardContent>
							<Skeleton className="h-8 w-16 bg-neutral-700 mb-2" />
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				<Card className="lg:col-span-2 bg-neutral-900 border-neutral-800">
					<CardHeader>
						<Skeleton className="h-6 w-32 bg-neutral-700 mb-2" />
						<Skeleton className="h-4 w-24 bg-neutral-700" />
					</CardHeader>
					<CardContent>
				...
				<Card className="bg-neutral-900 border-neutral-800">
					<CardHeader>
						<Skeleton className="h-6 w-28 bg-neutral-700 mb-2" />
