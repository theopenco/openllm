			...
			<div className="mb-8">
				<div className="flex items-center justify-between mb-4">
					...
					<div className="flex items-center gap-4">
						<div className="flex items-center gap-2">
							...
							<Skeleton className="h-6 w-3 bg-gray-800" />
						</div>
				...
				<div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
					<div className="flex items-end justify-between h-64 mb-4">
						<div className="flex flex-col justify-between h-full text-sm text-gray-500">
					...
					<div className="flex flex-wrap gap-4 text-sm">
						{Array.from({ length: 8 }).map((_, i) => (
							<div key={i} className="flex items-center gap-2">
								<Skeleton className="h-3 w-3 bg-gray-700 rounded-sm" />
